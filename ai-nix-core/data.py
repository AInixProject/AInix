...
lsdata = [
    ...
    ("list", "ls"),
    ("print the contents of this directory", "ls"),
    ...
    ("ls *.txt sorted by file size", "ls -lS *.txt"),
...
rmdata = [
    ...
    ("remove all text files", "rm *.txt"),
    ("remove all .csv files in this dir", "rm *.csv"),
...
touchData = [
    ...
    ("create a file name [-[FILENAME]-] in ..", "touch ../[-[FILENAME]-]"),
    ("make an empty file name [-[FILENAME]-] in my parent directory", "touch ../[-[FILENAME]-]"),
    ...
    ("set last mod time of [-[FILENAME]-] to current time", "touch [-[FILENAME]-]"),
