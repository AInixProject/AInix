...
class WhooshIndexBackend(index.IndexBackendABC):
    ...
    def _convert_to_whoosh_field(field: index.IndexBackendField) -> FieldType:
        ...
        """
        if field == index.IndexBackendFields.TEXT:
            return TEXT(stored=True)
        elif field == index.IndexBackendFields.ID:
            return ID(stored=True)
        elif field == index.IndexBackendFields.NUMBER:
            return NUMERIC(stored=True)
        elif field == index.IndexBackendFields.UNSTORED_TEXT:
    ...
    @staticmethod
    def _convert_to_whoosh_scheme(scheme: index.IndexBackendScheme) -> Schema:
