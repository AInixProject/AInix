"""Copyied from
ainix_kernel/model_util/transformer/sublayers.py
"""
...
class MultiHeadAttention(nn.Module):
    ...
    def _split_heads(self, x):
        ...
        shape = x.shape
        return x.view(shape[0], shape[1], self.num_heads, shape[2] // self.num_heads).permute(0, 2,
                                                                                              1, 3)
...
class PositionwiseFeedForward(nn.Module):
    ...
    def __init__(self, input_depth, filter_size, output_depth, layer_config='ll', padding='left',
                 dropout=0.0):
        """
        Parameters:
            input_depth: Size of last dimension of input
    ...
    def forward(self, inputs):
        # TODO (DNGros): Make this have a residual connection?
        x = inputs
